...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-back shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">Boy Application</a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <li><a class="dropdown-item" href="#">Blog Post 3</a></li>
                            </ul>
                        </li>
                    </ul>
